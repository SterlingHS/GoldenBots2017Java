...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        AutonomousModes.addObject("Drop Floor", new LowerTable());
        AutonomousModes.addObject("Drop Cable", new DropCable());
        AutonomousModes.addObject("Climb Rope", new ClimbRope());
