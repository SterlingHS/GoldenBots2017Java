...
public class RobotMap {
    ...
    public static SpeedController intakeSpeedController4;
    public static SpeedController outputSpeedController5;
    public static SpeedController climberSpeedController6;
    public static DigitalInput climberFloorUp;
    public static DigitalInput climberFloorDown;
    ...
    public static void init() {
        ...
        intakeSpeedController4 = new Spark(4);
        LiveWindow.addActuator("Intake", "Speed Controller 4", (Spark) intakeSpeedController4);
        
        outputSpeedController5 = new Spark(5);
        LiveWindow.addActuator("Output", "Speed Controller 5", (Spark) outputSpeedController5);
        
        climberSpeedController6 = new Spark(6);
        LiveWindow.addActuator("Climber", "Speed Controller 6", (Spark) climberSpeedController6);
        
        climberFloorUp = new DigitalInput(0);
        LiveWindow.addSensor("Climber", "Floor Up", climberFloorUp);
        
        climberFloorDown = new DigitalInput(1);
        LiveWindow.addSensor("Climber", "Floor Down", climberFloorDown);
